...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    x = 3 ** (player_score + opponent_score)
    lastDigit = x % 10
    firstDigit = x
    while firstDigit // 10:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    if feral_hogs:
        ...
        while score0 < goal and score1 < goal:
            ...
            num1 = 0
            if who == 0:
                num0 = take_turn(strategy0(score0, score1), score1, dice)
                if abs(strategy0(score0, score1) - pre0) == 2:
                    pre0 = num0
                    num0 += 3
                else:
                    pre0 = num0
                ...
                num1 = take_turn(strategy1(score1, score0), score0, dice)
                if abs(strategy1(score1, score0) - pre1) == 2:
                    pre1 = num1
                    num1 += 3
                else:
                    pre1 = num1
